...
- IN/OUT markers bound the exported span (full timeline by default; IN→end,
  start→OUT, or IN–OUT when both are set). Shown in the Export dialog.
